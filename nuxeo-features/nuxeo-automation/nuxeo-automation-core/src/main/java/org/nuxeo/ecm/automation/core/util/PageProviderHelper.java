...
public class PageProviderHelper {
    ...
    protected static String getRangeDateClause(String field, BucketRangeDate bucketRangeDate) {
        ...
        if (from == null && to != null) {
            return field + " < TIMESTAMP '" + format(nowIfNull(bucketRangeDate.getToAsDate())) + "'";
        } else if (from != null && to == null) {
            return field + " >= TIMESTAMP '" + format(nowIfNull(bucketRangeDate.getFromAsDate())) + "'";
        }
        return field + " BETWEEN TIMESTAMP '" + format(nowIfNull(bucketRangeDate.getFromAsDate()))
                + "' AND TIMESTAMP '" + format(nowIfNull(bucketRangeDate.getToAsDate())) + "'";
    }
